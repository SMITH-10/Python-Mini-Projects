...
try:
    data=pandas.read_csv("data/Python_Questions.csv")
except FileNotFoundError:
    orignal_data=pandas.read_csv("data/Python_Questions.csv")
...
def is_known():
    ...
    data.to_csv("data/Ques_to_learn.csv",index=FALSE)
    next_card()
...
card_word=canvas.create_text(400,263,text="",font=("Ariel",10,"italic"))
